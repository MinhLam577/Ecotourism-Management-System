        ...
        if (serviceComboIds.size > 0) {
          try {
            const comboPromises = Array.from(serviceComboIds).map(async (comboId) => {
              try {
                const comboResponse = await axiosInstance.get(
                  `${API_ENDPOINTS.SERVICE_COMBO}/${comboId}`
                )
  ...
  return (
    <div className="landing-page">
      ...
      <main>
              ...
              <div className={`hero-content ${isVisible ? 'fade-in-left' : ''}`}>
                ...
                <div className="hero-text">
                  ...
                  <p className="hero-description">
                    Đặt dịch vụ theo nhóm thông minh, tiết kiệm chi phí và tạo những kỷ niệm đáng
          ...
          <div className="section-container">
            ...
            >
              ...
              <p className="section-subtitle">
                Chúng tôi mang đến trải nghiệm du lịch sinh thái độc đáo với công nghệ đặt dịch vụ
                nhóm tiên tiến
              </p>
            </div>
                  ...
                  <div key={index} className="lp-service-card-skeleton">
                    <Card className="lp-service-card-inner">
                      <div
                        ...
                        style={{ backgroundColor: '#f1f5f9', height: '220px' }}
                      ></div>
        ...
        >
          <div className="section-container">
            ...
            >
              ...
              <p className="section-subtitle">
                Hơn 1,000+ khách hàng đã tin tưởng và có những trải nghiệm tuyệt vời cùng ESCE Du
                lịch
              </p>
            </div>
              ...
              <div className="reviews-carousel-wrapper">
                ...
                <div className="reviews-grid">
                  {displayReviews.map((review, index) => {
                    ...
                    const uniqueKey = reviewId
                      ? `review-${reviewId}-${currentReviewIndex}-${index}`
                      : `review-idx-${currentReviewIndex}-${index}`
        ...
        {/* CTA Section */}
        <section className="cta-section" id="cta" aria-labelledby="cta-title" data-section-id="cta">
          <div className="section-container">
            <div className={`cta-content ${visibleSections.has('cta') ? 'fade-in-up' : ''}`}>
              ...
              <p className="cta-subtitle">
                Hãy để chúng tôi mang đến cho bạn những trải nghiệm du lịch sinh thái tuyệt vời
                nhất.
              </p>
...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  const discountPercent =
    service.originalPrice && service.priceFrom
          ...
          <CardContent className="lp-service-content">
            ...
            <div className="lp-service-rating">
              <div className="lp-stars" aria-label={`Đánh giá ${service.rating || 0} sao`}>
                {(() => {
                  const rating =
                    service.rating !== undefined && service.rating !== null ? service.rating : 0
              ...
              <span className="lp-rating-value">
                (
